...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="index2.php">Elements Rent</a>
            ...
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <br>
                        <button class="btn btn-warning" type="button" id="btnVaciar">Finalizar Carrito</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Elements Rent</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
